...
public class MainPreferences {
	...
	public static void initZygote(
		...
		// sModRes = XModuleResources.createInstance(startupParam.modulePath,
		// null);
	...
	/**
	 * get the xBridge shared preference NOTE: this only used to get the
	 * preference from teh xposed init
	 */
	public static XSharedPreferences getSharedPreference() {
		if (sharedPreferences == null) {
			...
			sharedPreferences = new XSharedPreferences(
					StaticData.THIS_PACKAGE_NAME, NAME_PREFERENCE);
		}
	...
	/**
	 * every preference should call this method to set the name of the
	 * preference file
	 *
	 * @param preferenceManager
	 *            preference manager of this fragment
	 */
	...
	public static void setOnPreferenceChanged(Context context,
	...
	public static void unSetOnPreferenceChanged(
			PreferenceManager preferenceManager) {
		if (listener != null) {
			preferenceManager.getSharedPreferences()
	...
	public static SharedPreferences getEditablePreferences(
			PreferenceManager preferenceManager) {
	...
	/**
	 * this CAN'T be called within the activity cycle, use
	 * loadPreference(PreferenceManager) instead
	 */
