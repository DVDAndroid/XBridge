...
public final class StaticData {
	public static final String THIS_PACKAGE_NAME = XposedInit.class
			.getPackage().getName();
	...
	/*
	 * public static final boolean DEFAULT_SHOW_IN_RECENT_PANEL = false; public
	 * static final boolean DEFAULT_SHOW_IN_APP_INFO = false; public static
	 * final boolean DEFAULT_SHOW_IN_NOTIFICATION = false; public static final
	 * boolean DEFAULT_TWO_FINGER_IN_RECENT_PANEL = false;
	 */
	/*
	 * public static final boolean DEFAULT_DIRECTLY_SHOW_IN_PLAY = false; //
	 * browser-store swtich public static final boolean DEFAULT_USE_BROWSER =
	 * false; public static final boolean DEFAULT_DEBUG_LOGS = false;
	 */
