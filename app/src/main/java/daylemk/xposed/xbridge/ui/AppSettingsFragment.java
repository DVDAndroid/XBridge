...
public class AppSettingsFragment extends HeaderPreferenceFragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater,
		...
		preferenceStatusBar = (SwitchPreference) this
				.findPreference(AppSettingsAction.keyShowInStatusBar);
		preferenceRecentTask = (SwitchPreference) this
				.findPreference(AppSettingsAction.keyShowInRecentTask);
		preferenceAppInfo = (SwitchPreference) this
				.findPreference(AppSettingsAction.keyShowInAppInfo);
