...
/**
 * Created by DayLemK on 2015/5/14. Play Action settings fragment
 */
public class SearchFragment extends HeaderPreferenceFragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater,
		...
		preferenceStatusBar = (SwitchPreference) this
				.findPreference(SearchAction.keyShowInStatusBar);
		preferenceRecentTask = (SwitchPreference) this
				.findPreference(SearchAction.keyShowInRecentTask);
		preferenceAppInfo = (SwitchPreference) this
				.findPreference(SearchAction.keyShowInAppInfo);
		preferenceCustomizeUrl = (SwitchPreference) this
				.findPreference(SearchAction.keyCustomize);
		preferenceUrl = (EditTextPreference) this
				.findPreference(SearchAction.keyUrl);
		...
		addPreferences2TheList(preferenceStatusBar, preferenceRecentTask,
				preferenceAppInfo, preferenceCustomizeUrl);
