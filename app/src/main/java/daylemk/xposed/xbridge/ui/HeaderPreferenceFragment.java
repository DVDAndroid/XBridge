...
/**
 * Created by DayLemK on 2015/5/14. HeaderPreference which has a master switch
 */
public abstract class HeaderPreferenceFragment extends
		AbstractPreferenceFragment implements SwitchBar.OnSwitchChangeListener,
	...
	/**
	 * save the perference which use tag of switchView, and enable disable the
	 * sub preference.
	 *
	 * @param switchView
	 *            The Switch view whose state has changed.
	 * @param isChecked
	 *            The new checked state of switchView.
	 */
	@Override
	public void onSwitchChanged(Switch switchView, boolean isChecked) {
		...
		MainPreferences.getEditablePreferences(getPreferenceManager()).edit()
				.putBoolean((String) switchView.getTag(), isChecked).commit();
	...
	public boolean onPreferenceClick(Preference preference) {
		if (preference.equals(preferenceRebootSysUi)) {
			...
			AlertDialog dialog = builder
					.setMessage(R.string.title_reboot_system_ui)
