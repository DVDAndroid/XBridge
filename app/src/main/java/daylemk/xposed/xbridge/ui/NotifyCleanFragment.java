...
/**
 * Created by DayLemK on 2015/6/10. The fragment of NotifyClean
 */
public class NotifyCleanFragment extends HeaderPreferenceFragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater,
		...
		preferenceStatusBar = (SwitchPreference) this
				.findPreference(NotifyCleanAction.keyShowInStatusBar);
		preferenceRecentTask = (SwitchPreference) this
				.findPreference(NotifyCleanAction.keyShowInRecentTask);
		preferenceAppInfo = (SwitchPreference) this
				.findPreference(NotifyCleanAction.keyShowInAppInfo);
