...
/**
 * Created by DayLemK on 2015/5/14. AppOps Action settings fragment
 */
public class AppOpsFragment extends HeaderPreferenceFragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater,
		...
		preferenceStatusBar = (SwitchPreference) this
				.findPreference(AppOpsAction.keyShowInStatusBar);
		preferenceRecentTask = (SwitchPreference) this
				.findPreference(AppOpsAction.keyShowInRecentTask);
		// preferenceAppInfo = (SwitchPreference)
		// this.findPreference(PlayAction.keyShowInAppInfo);
