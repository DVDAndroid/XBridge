...
/**
 * Created by DayLemK on 2015/5/14. XPrivacy Action settings fragment
 */
public class XPrivacyFragment extends HeaderPreferenceFragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater,
		...
		preferenceStatusBar = (SwitchPreference) this
				.findPreference(XPrivacyAction.keyShowInStatusBar);
		preferenceRecentTask = (SwitchPreference) this
				.findPreference(XPrivacyAction.keyShowInRecentTask);
		preferenceAppInfo = (SwitchPreference) this
				.findPreference(XPrivacyAction.keyShowInAppInfo);
