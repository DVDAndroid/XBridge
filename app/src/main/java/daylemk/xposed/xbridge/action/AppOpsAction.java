...
/**
 * App Ops xposed Action Created by DayLemK on 2015/5/8.
 */
public class AppOpsAction extends Action {
	...
	public static final String ACTIVITY_CLASS_NAME = PKG_NAME
			+ ".AppOpsActivity";
	...
	public static void loadPreferenceKeys(Resources sModRes) {
		...
		keyShowInRecentTask = sModRes
				.getString(R.string.key_appops_recent_task);
		...
		showInStatusBarDefault = sModRes
				.getBoolean(R.bool.appops_status_bar_default);
		showInRecentTaskDefault = sModRes
				.getBoolean(R.bool.appops_recent_task_default);
		// showInAppInfoDefault =
		// sModRes.getBoolean(R.bool.appops_app_info_default);
	...
	public static void loadPreference(SharedPreferences preferences) {
		...
		Log.d(TAG, "load preference: " + "isShowInStatusBar:"
				...
				+ isShowInRecentTask + "isShow:" + isShow);
	}
	...
	public static boolean onReceiveNewValue(String key, String value) {
		...
		if (key.equals(keyShow)) {
			...
			/*
			 * } else if (key.equals(keyShowInAppInfo)) { isShowInAppInfo =
