...
/**
 * Created by DayLemK on 2015/6/2. The app info screen of app action
 */
public class AppInfoAction extends Action {
	...
	public static void loadPreferenceKeys(Resources sModRes) {
		...
		keyShowInRecentTask = sModRes
				.getString(R.string.key_appinfo_recent_task);
		...
		showInStatusBarDefault = sModRes
				.getBoolean(R.bool.appinfo_status_bar_default);
		showInRecentTaskDefault = sModRes
				.getBoolean(R.bool.appinfo_recent_task_default);
		// showInAppInfoDefault =
		// sModRes.getBoolean(R.bool.appinfo_app_info_default);
