...
public class AppSettingsAction extends Action {
	...
	public static void loadPreferenceKeys(Resources sModRes) {
		...
		keyShowInRecentTask = sModRes
				.getString(R.string.key_appsettings_recent_task);
		keyShowInStatusBar = sModRes
				.getString(R.string.key_appsettings_status_bar);
		// get the default value of this action
		showInStatusBarDefault = sModRes
				.getBoolean(R.bool.appsettings_status_bar_default);
		showInRecentTaskDefault = sModRes
				.getBoolean(R.bool.appsettings_recent_task_default);
		showInAppInfoDefault = sModRes
				.getBoolean(R.bool.appsettings_app_info_default);
