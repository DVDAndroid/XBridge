...
public class PlayAction extends Action {
	...
	public static void loadPreferenceKeys(Resources sModRes) {
		...
		showInStatusBarDefault = sModRes
				.getBoolean(R.bool.play_status_bar_default);
		showInRecentTaskDefault = sModRes
				.getBoolean(R.bool.play_recent_task_default);
	...
	public Drawable getIcon(PackageManager packageManager) {
		...
		// TODO: check if the app is just install or upgrade and the icon should
		// be changed
		if (sIcon == null) {
	...
	protected Intent getIntent(Hook hook, Context context, String pkgName) {
		...
		intent.setData(Uri.parse((isMarket ? URI_MARKET : URI_BROWSER)
				+ pkgName));
		return intent;
	}
