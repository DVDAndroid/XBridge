...
/**
 * Created by DayLemK on 2015/5/29. The XPrivacy Action
 */
public class XPrivacyAction extends Action {
	...
	public static void loadPreferenceKeys(Resources sModRes) {
		...
		keyShowInRecentTask = sModRes
				.getString(R.string.key_xprivacy_recent_task);
		keyShowInStatusBar = sModRes
				.getString(R.string.key_xprivacy_status_bar);
		// get the default value of this action
		showInStatusBarDefault = sModRes
				.getBoolean(R.bool.xprivacy_status_bar_default);
		showInRecentTaskDefault = sModRes
				.getBoolean(R.bool.xprivacy_recent_task_default);
		showInAppInfoDefault = sModRes
				.getBoolean(R.bool.xprivacy_app_info_default);
